...
- Skill name: `cpq-rate-card-reconciliation-based-on-gold-standard-rate-card`
- Skill description: This prompt reconciles a newly generated CPQ rate card against the approved local Gold Standard Rate Card created in Prompt 'Generate Gold Standard Rate Card for CPQ Reconciliation'. This provides a repeatable validation process for future quotes and identifies whether the current CPQ Unit Selling
- Skill file: `skills/cpq-rate-card-reconciliation-based-on-gold-standard-rate-card/SKILL.md`
